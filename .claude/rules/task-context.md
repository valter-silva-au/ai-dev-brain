...
- **2026-02-14**: learning: No AU RE competitor in autonomous + omnichannel quadrant. Five defensible moats identified. (TASK-00037)
- **2026-02-14**: learning: OpenClaw-aaS platform strategy -- 4-tier pricing, base case $624K ARR Year 1 WA, 93.6% gross margin, ~18K national TAM (TASK-00037)
- **2026-02-14**: learning: ~70% of Sovereign Agent research already implemented in Propella. Genuinely new: VaultRE CRM, CMA generation, AU PII guardrails. (TASK-00037)
- **2026-02-14**: decision: WA beachhead GTM via REIWA + PropTech Hub + Mandurah Tech Fest (TASK-00037)
- **2026-02-14**: decision: Bedrock Guardrails already integrated -- only need AU PII patterns added (TASK-00037)
- **2026-02-14**: decision: Defer AML/CTF -- Tranche 2 legislation not yet passed for AU real estate (TASK-00037)
- **2026-02-14**: decision: Single region to 200 tenants, multi-region at 200+ (TASK-00037)
