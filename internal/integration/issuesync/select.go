...
// NOT github.com or a gitlab host (e.g. Amazon-internal code.aws.dev /
// code.amazon.com, which are CRUX/Taskei, not gh/glab). This is the resolved
// open question: only tickets whose repo names a real GitHub/GitLab remote
// are synced.
//
