...
// Amazon-internal hosts (code.aws.dev, code.amazon.com), non-triple repos -
// returns ok=false and is skipped by the syncer.
//
...
func TestProviderFor(t *testing.T) {
	cases := []struct {
		...
		{"./relative", false, "", "", ""},
		{"../also-local", false, "", "", ""},
		{"code.internal-corp.dev/team/thing", false, "", "", ""},   // fictional internal tenant
		{"code.internal-corp.dev/packages/foo", false, "", "", ""}, // fictional internal tenant
